...
namespace StoreFlow.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            var value = _context.Products.Include(x => x.Category).Take(5).ToList();
            return View(value);
        }
        public IActionResult First4ProductList()
        {
            var value = _context.Products.Include(x => x.Category).Take(4).ToList();
            return View(value);
        }
        public IActionResult Skip4ProductList()
        {
            var value = _context.Products.Include(x => x.Category).Skip(4).Take(10).ToList();
            return View(value);
        }
